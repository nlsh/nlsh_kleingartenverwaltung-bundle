...
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi02GartenstammJaNein'][1]    = 'Soll Individuell 02 aus den Jahresstammdaten des Vereines berechnet werden?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi03GartenstammJaNein'][0]    = 'Individuell 03 aus Gartenstamm berechnen?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi03GartenstammJaNein'][1]    = 'Soll Individuell 03 aus den Jahresstammdaten des Vereines berechnet werden?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi04GartenstammJaNein'][0]    = 'Individuell 04 aus Gartenstamm berechnen?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi04GartenstammJaNein'][1]    = 'Soll Individuell 04 aus den Jahresstammdaten des Vereines berechnet werden?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi01Name'][0] = 'Name individuell 1';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi01Name'][1] = 'Geben Sie bitte den 1. Namen der individuellen Abrechnungsart ein!';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi01Wert'][0] = 'Wert individuell 1';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi01Wert'][1] = 'Geben Sie bitte den 1. Wert in EUR  der individuellen Abrechnungsart ein!';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi01Dauer'][0]                = 'Abrechnung individuell 1 dauerhaft?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi01Dauer'][1]                = 'Soll die Abrechnung der ersten individuellen Abrechnungsart dauerhaft abgerechnet werden?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi02Name'][0] = 'Name individuell 2';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi02Name'][1] = 'Geben Sie bitte den 2. Namen der individuellen Abrechnungsart ein!';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi02Wert'][0] = 'Wert individuell 2';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi02Wert'][1] = 'Geben Sie bitte den 2. Wert in EUR  der individuellen Abrechnungsart ein!';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi02Dauer'][0]                = 'Abrechnung individuell 2 dauerhaft?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi02Dauer'][1]                = 'Soll die Abrechnung der zweiten individuellen Abrechnungsart dauerhaft abgerechnet werden?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi03Name'][0] = 'Name individuell 3';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi03Name'][1] = 'Geben Sie bitte den 3. Namen der individuellen Abrechnungsart ein!';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi03Wert'][0] = 'Wert individuell 3';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi03Wert'][1] = 'Geben Sie bitte den 3. Wert in EUR  der individuellen Abrechnungsart ein!';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi03Dauer'][0]                = 'Abrechnung individuell 3 dauerhaft?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi03Dauer'][1]                = 'Soll die Abrechnung der dritten individuellen Abrechnungsart dauerhaft abgerechnet werden?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi04Name'][0] = 'Name individuell 4';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi04Name'][1] = 'Geben Sie bitte den 4. Namen der individuellen Abrechnungsart ein!';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi04Wert'][0] = 'Wert individuell 4';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['abrechnungGartenIndi04Wert'][1] = 'Geben Sie bitte den 4. Wert in EUR  der individuellen Abrechnungsart ein!';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi04Dauer'][0]                = 'Abrechnung individuell 4 dauerhaft?';
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['indi04Dauer'][1]                = 'Soll die Abrechnung der vierten individuellen Abrechnungsart dauerhaft abgerechnet werden?';
...
$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['nichtVergeben'] = 'nicht vergeben';

/*
 * Fehler- Meldungen
 */

$GLOBALS['TL_LANG']['tl_nlsh_garten_garten_data']['neuanlageNicht'] = 'Einen neuen Garten kann man nur im h&ouml;chsten Jahr anlegen!';
