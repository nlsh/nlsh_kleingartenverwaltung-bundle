...
$GLOBALS['TL_LANG']['MOD']['nlsh_Kleingartenverwaltung'] = 'Kleingartenverwaltung';

/*
 * Hauptmenü
 */

$GLOBALS['TL_LANG']['MOD']['Kleingartenverwaltung'] = 'Kleingartenverwaltung';
...
$GLOBALS['TL_LANG']['FMD']['nlsh_gesamtausgabe'][0]        = 'Gesamtabrechnung';
$GLOBALS['TL_LANG']['FMD']['nlsh_gesamtausgabe'][1]        = 'Stellt alle Daten zur Abrechnung der Gartenanlage zur Verf&uuml;gung';
